...
const Navigation = () => {
  ...
  const navLinks = [
    { path: "/", label: "Home" },
    { path: "/chauffeur-services", label: "Chauffeur Services" },
    { path: "/close-protection", label: "Close Protection" },
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center">
            <span className="text-2xl font-display font-bold text-gradient-metal">
              Supreme Drive
            </span>
          </Link>
